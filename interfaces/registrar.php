		...
		<div class="container mx-auto text-center center card ">
			<div class="card-body">
				<form action="" class="row g-3">
					...
					<div class="col-md-4">
						<label for="cod_cocinero" class="form-label">Código cocinero<small class="text-danger"></small></label>
						<input type="text" class="form-control" id="cod_cocinero" name= "cod_cocinero" placeholder="código">
					</div>

					<div class="col-md-4">
						<label for="cod_mesero" class="form-label">Código mesero<small class="text-danger"></small></label>
						<input type="text" class="form-control" id="cod_mesero" name= "cod_mesero" placeholder="código">
					</div>
